...
/**
 * GeodeticInformation interface - Stub for jSS7 9.2.5 compatibility
 * Represents geodetic coordinates based on a reference frame
 */
public interface GeodeticInformation {
    
    /**
     * Gets the screening and presentation indicators
     * @return the screening and presentation indicators
     */
