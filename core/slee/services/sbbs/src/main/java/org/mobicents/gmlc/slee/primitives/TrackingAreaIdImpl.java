...
public class TrackingAreaIdImpl extends OctetStringBase implements TrackingAreaId {
  ...
  public TrackingAreaIdImpl(byte[] data) {
    super(5, 5, "TrackingAreaId", data);
  }
   ...
   */
  protected static final XMLFormat<TrackingAreaIdImpl> TA_ID_XML = new XMLFormat<>(TrackingAreaIdImpl.class) {
