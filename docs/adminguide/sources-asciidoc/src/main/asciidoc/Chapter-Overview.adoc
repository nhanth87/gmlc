...
** Mobile Application Part (MAP): https://www.3gpp.org/ftp/Specs/archive/29_series/29.002/29002-i00.zip[3GPP TS 29.002] (version 18.0.0, latest released for MAP by 3GPP on 2023-09-20).
