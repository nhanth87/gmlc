...
[source,shell]
----
curl -d "msisdn=573195897484&operation=UDR&token=RmVybmFuZG9NZW5kaW9yb3o&ratTypeRequested=true" -X POST 127.0.0.1:8080/restcomm/gmlc/rest
----
...
[source,shell]
----
curl -d "token=n4ndO&msisdn=59898077939&operation=UDR&locationInfoEps=false&activeLocation=false" -X POST 192.168.87.100:8080/restcomm/gmlc/rest -X POST 127.0.0.1:8080/restcomm/gmlc/rest
----
...
[source,shell]
----
curl -d "msisdn=573017706052&operation=UDR&token=RmVybmFuZG9NZW5kaW9yb3o&domain=cs&ratTypeRequested=true" -X POST 127.0.0.1:8080/restcomm/gmlc/rest
----
...
[source,shell]
----
curl -d "msisdn=61909077937&operation=PSL&lcsClientType=0&lcsClientExternalID=6543210987&lcsLocationType=currentLocation&clientReferenceNumber=30000&token=RmVybmFuZG9NZW5kaW9yb3o" -X POST 127.0.0.1:8080/restcomm/gmlc/rest
----
