...
| System Requirements | Intel Pentium 1.5 GHz or faster. Hard disk space of at least 50GB. RAM of at least 4 GB for PoC and at least 16 GB for production | The higher the RAM and processing power, the better the throughput
...
| Java | You must have a working Java Runtime Environment (JRE) or Java Development Kit (JDK) installed on your system, and it must be version 11. |
